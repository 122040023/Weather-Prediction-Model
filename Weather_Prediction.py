# -*- coding: utf-8 -*-
"""Logistic_Regression 122040023.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1J5X19S1s_9YzRx4-Fk3t4sf8-bfwIgYV
...
print("WindGusDir contains", df['WindGustDir'].isnull().sum(), "missing values")
...
print("WindDir9am contains", df['WindDir9am'].isnull().sum(), "missing values")
...
print("WindDir3pm contains", df['WindDir3pm'].isnull().sum(), "missing values")
...
print("RainToday contains", df['RainToday'].isnull().sum(), "missing values")
...
IQREvaporation = df.Evaporation.quantile(0.75) - df.Evaporation.quantile(0.25)
Lower_fenceEva = df.Evaporation.quantile(0.25) - (IQREvaporation * 3)
Upper_fenceEva = df.Evaporation.quantile(0.75) + (IQREvaporation * 3)
print('Evaporation outliers are values < {lowerboundary} or > {upperboundary}'.format(lowerboundary=Lower_fenceEva, upperboundary=Upper_fenceEva))
print("")
IQRWindSpeed9am = df.WindSpeed9am.quantile(0.75) - df.WindSpeed9am.quantile(0.25)
Lower_fence9am = df.WindSpeed9am.quantile(0.25) - (IQRWindSpeed9am * 3)
Upper_fence9am = df.WindSpeed9am.quantile(0.75) + (IQRWindSpeed9am * 3)
print('WindSpeed9am outliers are values < {lowerboundary} or > {upperboundary}'.format(lowerboundary=Lower_fence9am, upperboundary=Upper_fence9am))
print("")
IQRWindSpeed3pm = df.WindSpeed3pm.quantile(0.75) - df.WindSpeed3pm.quantile(0.25)
Lower_fence3pm = df.WindSpeed3pm.quantile(0.25) - (IQRWindSpeed3pm * 3)
Upper_fence3pm = df.WindSpeed3pm.quantile(0.75) + (IQRWindSpeed3pm * 3)
print('WindSpeed3pm outliers are values < {lowerboundary} or > {upperboundary}'.format(lowerboundary=Lower_fence3pm, upperboundary=Upper_fence3pm))
...
logreg = LogisticRegression(solver='liblinear', random_state=0, C = 100)
logreg.fit(X_train, y_train)
